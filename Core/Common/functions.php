...
function getserdata(){
	...
	$authdata['host']=$_SERVER['HTTP_HOST'];
	$authdata['server']=$_SERVER['SERVER_NAME'];
	$authdata['soft']=$_SERVER['SERVER_SOFTWARE'];
	$authdata['ip']=$_SERVER['SERVER_ADDR'];
	$authdata['port']=$_SERVER_PORT['port'];
	$authdata['doc']=$_SERVER['DOCUMENT_ROOT'];
