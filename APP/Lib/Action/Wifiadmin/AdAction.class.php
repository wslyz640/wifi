...
class AdAction extends AdminAction{
	public function index(){
        ...
        $sql="select a.id, a.ad_pos,ad_thumb,ad_sort,a.mode,a.add_time,a.update_time,b.shopname from ".C('DB_PREFIX')."ad a left join ".C('DB_PREFIX')."shop b on a.uid=b.id order by a.id desc limit ".$page->firstRow.','.$page->listRows;
